...
See Fig. 5.17.
Record Model of Vehicle with Rigid Frame
...
\( V_{x} \)  = x-component of velocity of G parallel to x-axis
\(\mathrm{V_y} = \gamma\) -component of velocity of G perpendicular to x-axis