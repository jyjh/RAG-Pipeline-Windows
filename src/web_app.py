...
def _load_ingestion_config(config_path: Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "scanned_ocr_engine": _nonempty_str(ingestion.scanned_ocr_engine, DEFAULT_SCANNED_OCR_ENGINE),
        "unlimited_ocr_model": _nonempty_str(ingestion.unlimited_ocr_model, DEFAULT_UNLIMITED_OCR_MODEL),
        "unlimited_ocr_dpi": _positive_int(ingestion.unlimited_ocr_dpi, DEFAULT_UNLIMITED_OCR_DPI),
        "vision_ocr_model": _nonempty_str(ingestion.vision_ocr_model, DEFAULT_VISION_OCR_MODEL),
        "vision_ocr_dpi": _positive_int(ingestion.vision_ocr_dpi, DEFAULT_VISION_OCR_DPI),
